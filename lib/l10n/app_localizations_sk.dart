...
class AppLocalizationsSk extends AppLocalizations {
  ...
  @override
  String get pulseUseServerTitle => 'Použiť server Pulse?';

  @override
  String pulseUseServerBody(String name, String host) {
    return '$name používa server Pulse $host. Pripojiť sa, aby ste si mohli rýchlejšie chatovať (a s ostatnými na rovnakom serveri)?';
  }

  @override
  String pulseContactUsesPulse(String name) {
    return '$name používa Pulse';
  }

  @override
  String pulseJoinForFaster(String host) {
    return 'Pripojiť sa k $host pre rýchlejší chat';
  }

  @override
  String get pulseNotNow => 'Teraz nie';

  @override
  String get pulseJoin => 'Pripojiť sa';

  @override
  String get pulseDismiss => 'Zavrieť';

  @override
  String get pulseHide7Days => 'Skryť na 7 dní';

  @override
  String get pulseNeverAskAgain => 'Nepýtať sa znova';

  @override
  String get groupSearchContactsHint => 'Hľadať kontakty…';
  ...
  String systemTtlEnabled(String actor, String duration) {
    return '$actor zapol(a) miznúce správy: $duration';
  }

  @override
  String systemTtlDisabled(String actor) {
    return '$actor vypol(a) miznúce správy';
  }

  @override
  String get menuClearChatHistory => 'Vymazať históriu chatu';
  ...
  String get clearChatBody =>
      'Všetky správy v tomto chate sa vymažú z tohto zariadenia. Druhá osoba si svoju kópiu ponechá.';
  ...
  @override
  String get drawerCreateGroup => 'Vytvoriť skupinu';

  @override
  String get drawerJoinGroup => 'Pripojiť sa k skupine';
  ...
  @override
  String get groupModeMeshTitle => 'Obyčajná';

  @override
  String groupModeMeshSubtitle(int n) {
    return 'Bez servera, až $n osôb';
  }
  ...
  String get groupPulseServerClosed =>
      'Uzavretý server (vyžaduje pozvánkový kód)';
  ...
  String groupMeshLimitReached(int n) {
    return 'Tento typ hovoru je obmedzený na $n osôb';
  }
}
