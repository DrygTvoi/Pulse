...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String systemGroupMetaChanged(String actor, String name) {
    return '$actor renamed the group to \"$name\" and changed the photo';
  }

  @override
  String get profileInviteLink => 'Invite link';
  ...
  @override
  String get profileInviteLinkCopied => 'Invite link copied to clipboard';

  @override
  String get groupInviteLinkTitle => 'Join group?';

  @override
  String groupInviteLinkBody(String name, int count) {
    return 'You\'ve been invited to join \"$name\" ($count members).';
  }

  @override
  String get groupInviteLinkJoin => 'Join';

  @override
  String get drawerCreateGroup => 'Create group';

  @override
  String get drawerJoinGroup => 'Join group';
  ...
  @override
  String get groupModeMeshTitle => 'Regular';

  @override
  String groupModeMeshSubtitle(int n) {
    return 'No server, up to $n people';
  }
  ...
  String groupModePulseSubtitle(int n) {
    return 'Server-relayed, up to $n people';
  }
  ...
  @override
  String get groupPulseServerClosed => 'Closed server (needs invite code)';

  @override
  String get groupPulseInviteHint => 'Invite code';

  @override
  String pulseGroupForeignServerBanner(String host) {
    return 'Messages routed via $host (not your Pulse server)';
  }

  @override
  String groupMeshLimitReached(int n) {
    return 'This call type is limited to $n people';
  }
}
