...
class AppLocalizationsPl extends AppLocalizations {
  ...
  @override
  String get pulseUseServerTitle => 'Użyć serwera Pulse?';

  @override
  String pulseUseServerBody(String name, String host) {
    return '$name używa serwera Pulse $host. Dołączyć, aby szybciej rozmawiać (i z innymi na tym samym serwerze)?';
  }

  @override
  String pulseContactUsesPulse(String name) {
    return '$name używa Pulse';
  }

  @override
  String pulseJoinForFaster(String host) {
    return 'Dołącz do $host, aby szybciej rozmawiać';
  }

  @override
  String get pulseNotNow => 'Nie teraz';

  @override
  String get pulseJoin => 'Dołącz';

  @override
  String get pulseDismiss => 'Zamknij';

  @override
  String get pulseHide7Days => 'Ukryj na 7 dni';

  @override
  String get pulseNeverAskAgain => 'Nie pytaj ponownie';
  ...
  String systemGroupRenamed(String actor, String name) {
    return '$actor zmienił(a) nazwę grupy na „$name\"';
  }

  @override
  String systemGroupAvatarChanged(String actor) {
    return '$actor zmienił(a) zdjęcie grupy';
  }

  @override
  String systemGroupMetaChanged(String actor, String name) {
    return '$actor zmienił(a) nazwę grupy na „$name\" i zdjęcie';
  }

  @override
  String get profileInviteLink => 'Link zapraszający';

  @override
  String get profileInviteLinkSubtitle =>
      'Każdy z linkiem może dołączyć do grupy';

  @override
  String get profileInviteLinkCopied => 'Link zapraszający skopiowany';

  @override
  String get groupInviteLinkTitle => 'Dołączyć do grupy?';

  @override
  String groupInviteLinkBody(String name, int count) {
    return 'Zostałeś zaproszony do „$name\" ($count członków).';
  }
  ...
  @override
  String get groupModePulseTitle => 'Serwer Pulse';
  ...
  String pulseGroupForeignServerBanner(String host) {
    return 'Wiadomości przesyłane przez $host (nie twój serwer Pulse)';
  }
