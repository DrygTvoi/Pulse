...
class AppLocalizationsNl extends AppLocalizations {
  ...
  @override
  String get onboardingGetStarted => 'Account aanmaken';
  ...
  @override
  String get passwordMinChars => 'Wachtwoord moet minstens 8 tekens lang zijn';

  @override
  String get passwordNeedsVariety =>
      'Moet letters, cijfers en speciale tekens bevatten';

  @override
  String get passwordRequirements =>
      'Min. 8 tekens met letters, cijfers en een speciaal teken';
  ...
  @override
  String get torForceNostrTitle => 'Berichten via Tor routeren';

  @override
  String get torForceNostrSubtitle =>
      'Alle Nostr relay-verbindingen gaan via Tor. Langzamer maar verbergt uw IP voor relays.';

  @override
  String get torForceNostrDisabled => 'Tor moet eerst worden ingeschakeld';

  @override
  String get torForcePulseTitle => 'Pulse relay via Tor routeren';

  @override
  String get torForcePulseSubtitle =>
      'Alle Pulse relay-verbindingen gaan via Tor. Langzamer maar verbergt uw IP voor de server.';

  @override
  String get torForcePulseDisabled => 'Tor moet eerst worden ingeschakeld';
  ...
  @override
  String get setupNext => 'Volgende';

  @override
  String get setupKeyWarning =>
      'Er wordt een herstelsleutel voor je gegenereerd. Dit is de enige manier om je account op een nieuw apparaat te herstellen — er is geen server, geen wachtwoordreset.';

  @override
  String get setupKeyTitle => 'Je herstelsleutel';

  @override
  String get setupKeySubtitle =>
      'Schrijf deze sleutel op en bewaar hem op een veilige plek. Je hebt hem nodig om je account op een nieuw apparaat te herstellen.';

  @override
  String get setupKeyCopied => 'Gekopieerd!';

  @override
  String get setupKeyWroteItDown => 'Ik heb het opgeschreven';

  @override
  String get setupKeyWarnBody =>
      'Schrijf deze sleutel op als back-up. Je kunt hem ook later bekijken in Instellingen → Beveiliging.';

  @override
  String get setupVerifyTitle => 'Herstelsleutel verifiëren';

  @override
  String get setupVerifySubtitle =>
      'Voer je herstelsleutel opnieuw in om te bevestigen dat je hem correct hebt opgeslagen.';

  @override
  String get setupVerifyButton => 'Verifiëren';

  @override
  String get setupKeyMismatch =>
      'Sleutel komt niet overeen. Controleer en probeer opnieuw.';

  @override
  String get setupSkipVerify => 'Verificatie overslaan';

  @override
  String get setupSkipVerifyTitle => 'Verificatie overslaan?';

  @override
  String get setupSkipVerifyBody =>
      'Als je je herstelsleutel verliest, kan je account niet worden hersteld. Weet je het zeker?';

  @override
  String get setupCreatingAccount => 'Account aanmaken…';

  @override
  String get setupRestoringAccount => 'Account herstellen…';

  @override
  String get restoreKeyInfoBanner =>
      'Voer je herstelsleutel in — je adres (Nostr + Session) wordt automatisch hersteld. Contacten en berichten werden alleen lokaal opgeslagen.';

  @override
  String get restoreKeyHint => 'Herstelsleutel';

  @override
  String get settingsViewRecoveryKey => 'Herstelsleutel bekijken';

  @override
  String get settingsViewRecoveryKeySubtitle =>
      'Toon je account-herstelsleutel';

  @override
  String get settingsRecoveryKeyNotStored =>
      'Herstelsleutel niet beschikbaar (aangemaakt vóór deze functie)';

  @override
  String get settingsRecoveryKeyWarning =>
      'Bewaar deze sleutel veilig. Iedereen die hem heeft, kan je account op een ander apparaat herstellen.';

  @override
  String get replaceIdentityTitle => 'Bestaande identiteit vervangen?';

  @override
  String get replaceIdentityBodyRestore =>
      'Er bestaat al een identiteit op dit apparaat. Herstellen vervangt permanent je huidige Nostr-sleutel en Oxen-seed. Alle contacten verliezen de mogelijkheid om je huidige adres te bereiken.\n\nDit kan niet ongedaan worden gemaakt.';

  @override
  String get replaceIdentityBodyCreate =>
      'Er bestaat al een identiteit op dit apparaat. Een nieuwe maken vervangt permanent je huidige Nostr-sleutel en Oxen-seed. Alle contacten verliezen de mogelijkheid om je huidige adres te bereiken.\n\nDit kan niet ongedaan worden gemaakt.';

  @override
  String get replace => 'Vervangen';

  @override
  String get callNoScreenSources => 'Geen schermbronnen beschikbaar';

  @override
  String get callScreenShareQuality => 'Kwaliteit schermdeling';

  @override
  String get callFrameRate => 'Framesnelheid';

  @override
  String get callResolution => 'Resolutie';

  @override
  String get callAutoResolution => 'Auto = oorspronkelijke schermresolutie';

  @override
  String get callStartSharing => 'Delen starten';

  @override
  String get callCameraUnavailable =>
      'Camera niet beschikbaar — wordt mogelijk gebruikt door een andere app';

  @override
  String get themeResetToDefaults => 'Standaardwaarden herstellen';

  @override
  String get backupSaveToDownloadsTitle => 'Back-up opslaan in Downloads?';

  @override
  String backupSaveToDownloadsBody(String path) {
    return 'Geen bestandskiezer beschikbaar. De back-up wordt opgeslagen in:\n$path';
  }

  @override
  String get systemLabel => 'Systeem';
  ...
  String devTapsRemaining(int remaining) {
    return 'Nog $remaining keer tikken om ontwikkelaarsmodus in te schakelen';
  }

  @override
  String get devModeEnabled => 'Ontwikkelaarsmodus ingeschakeld';

  @override
  String get devTools => 'Ontwikkelaarstools';

  @override
  String get devAdapterDiagnostics => 'Adapterschakelaars & diagnostiek';

  @override
  String get devEnableAll => 'Alles inschakelen';

  @override
  String get devDisableAll => 'Alles uitschakelen';

  @override
  String get turnUrlValidation =>
      'TURN-URL moet beginnen met turn: of turns: (max 512 tekens)';

  @override
  String get callMissedCall => 'Gemist gesprek';

  @override
  String get callOutgoingCall => 'Uitgaand gesprek';

  @override
  String get callIncomingCall => 'Inkomend gesprek';

  @override
  String get mediaMissingData => 'Ontbrekende mediagegevens';

  @override
  String get mediaDownloadFailed => 'Download mislukt';

  @override
  String get mediaDecryptFailed => 'Ontsleuteling mislukt';

  @override
  String get callEndCallBanner => 'Gesprek beëindigen';

  @override
  String get meFallback => 'Ik';

  @override
  String get imageSaveToDownloads => 'Opslaan in Downloads';
  ...
  String get callScreenShareRequiresPermission =>
      'Schermdeling vereist toestemming';

  @override
  String get callScreenShareUnavailable => 'Schermdeling niet beschikbaar';

  @override
  String get statusJustNow => 'Zojuist';
  ...
  @override
  String get addContactReadyToAdd => 'Klaar om toe te voegen';
  ...
  @override
  String get sfuAudioOnly => 'Alleen audio';
  ...
  @override
  String get dataUnencryptedBackup => 'Niet-versleutelde back-up';

  @override
  String get dataUnencryptedBackupBody =>
      'Dit bestand is een niet-versleutelde identiteitsback-up en overschrijft je huidige sleutels. Importeer alleen bestanden die je zelf hebt gemaakt. Doorgaan?';

  @override
  String get dataImportAnyway => 'Toch importeren';

  @override
  String get securityStorageError => 'Beveiligingsopslagfout — herstart de app';

  @override
  String get aboutDevModeActive => 'Ontwikkelaarsmodus actief';

  @override
  String get themeColors => 'Kleuren';

  @override
  String get themePrimaryAccent => 'Primair accent';

  @override
  String get themeSecondaryAccent => 'Secundair accent';

  @override
  String get themeBackground => 'Achtergrond';

  @override
  String get themeSurface => 'Oppervlak';

  @override
  String get themeChatBubbles => 'Chatballonnen';

  @override
  String get themeOutgoingMessage => 'Uitgaand bericht';

  @override
  String get themeIncomingMessage => 'Inkomend bericht';

  @override
  String get themeShape => 'Vorm';

  @override
  String get devSectionDeveloper => 'Ontwikkelaar';

  @override
  String get devAdapterChannelsHint =>
      'Adapterkanalen — schakel uit om specifieke transporten te testen.';
  ...
  @override
  String get devSessionNetwork => 'Session-netwerk';

  @override
  String get devPulseRelay => 'Pulse zelf-gehost relay';

  @override
  String get devLanNetwork => 'Lokaal netwerk (UDP/TCP)';

  @override
  String get devSectionCalls => 'Gesprekken';

  @override
  String get devForceTurnRelay => 'TURN-relay forceren';

  @override
  String get devForceTurnRelaySubtitle =>
      'P2P uitschakelen — alle gesprekken alleen via TURN-servers';

  @override
  String get devRestartWarning =>
      '⚠ Wijzigingen worden toegepast bij volgende verzending/oproep. Herstart de app om toe te passen op inkomende.';
  ...
  @override
  String get pulseUseServerTitle => 'Pulse-server gebruiken?';

  @override
  String pulseUseServerBody(String name, String host) {
    return '$name gebruikt de Pulse-server $host. Deelnemen om sneller met deze persoon (en anderen op dezelfde server) te chatten?';
  }

  @override
  String pulseContactUsesPulse(String name) {
    return '$name gebruikt Pulse';
  }

  @override
  String pulseJoinForFaster(String host) {
    return 'Neem deel aan $host voor sneller chatten';
  }

  @override
  String get pulseNotNow => 'Niet nu';

  @override
  String get pulseJoin => 'Deelnemen';

  @override
  String get pulseDismiss => 'Sluiten';

  @override
  String get pulseHide7Days => 'Verbergen voor 7 dagen';

  @override
  String get pulseNeverAskAgain => 'Niet meer vragen';
  ...
  String pulseGroupForeignServerBanner(String host) {
    return 'Berichten verzonden via $host (niet uw Pulse-server)';
  }
