...
import 'signal_events.dart';

// Re-export so existing `import '.../signal_dispatcher.dart'` callers
// keep getting the event types without having to add a second import.
export 'signal_events.dart';
